...
import {MDBCollapse, MDBBtn, MDBCol, MDBIcon} from "mdbreact";
  ...
  render() {
    ...
    let categories = this.props.categories,
      ...
      categoryLinks = categories.map(
        (category, index) =>
          <MenuLink key={index} to={"categories/" + category.slug} title={category.name}/>
      );
...
export default windowSize(CategoryMenuLinks);
